...
[ 12] = {"brk", {T_ADDR, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_INT}, &syscall64_generic_handler},
[ 13] = {"rt_sigaction", {T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_LLINT}, &syscall64_generic_handler}, // Failed to retrieve prototype
[ 14] = {"rt_sigprocmask", {T_INT, T_ADDR, T_ADDR, T_ULINT, T_NONE, T_NONE, T_INT}, &syscall64_generic_handler},
[ 15] = {"rt_sigreturn", {T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_LLINT}, &syscall64_generic_handler}, // Failed to retrieve prototype
[ 16] = {"ioctl", {T_INT, T_ULINT, T_ULLINT, T_NONE, T_NONE, T_NONE, T_INT}, &syscall64_generic_handler},
...
[ 25] = {"mremap", {T_ADDR, T_ULINT, T_ULINT, T_INT, T_ULLINT, T_NONE, T_ADDR}, &syscall64_generic_handler},
...
[ 56] = {"clone", {T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_LLINT}, &syscall64_generic_handler}, // Failed to retrieve prototype
...
[ 66] = {"semctl", {T_INT, T_INT, T_INT, T_ULLINT, T_NONE, T_NONE, T_INT}, &syscall64_generic_handler},
...
[ 72] = {"fcntl", {T_INT, T_INT, T_ULLINT, T_NONE, T_NONE, T_NONE, T_INT}, &syscall64_generic_handler},
...
[125] = {"capget", {T_UNKNOWN, T_UNKNOWN, T_NONE, T_NONE, T_NONE, T_NONE, T_INT}, &syscall64_generic_handler}, // Unknown type
[126] = {"capset", {T_UNKNOWN, T_UNKNOWN, T_NONE, T_NONE, T_NONE, T_NONE, T_INT}, &syscall64_generic_handler}, // Unknown type
[127] = {"rt_sigpending", {T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_LLINT}, &syscall64_generic_handler}, // Failed to retrieve prototype
[128] = {"rt_sigtimedwait", {T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_LLINT}, &syscall64_generic_handler}, // Failed to retrieve prototype
[129] = {"rt_sigqueueinfo", {T_INT, T_INT, T_ADDR, T_NONE, T_NONE, T_NONE, T_INT}, &syscall64_generic_handler},
[130] = {"rt_sigsuspend", {T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_LLINT}, &syscall64_generic_handler}, // Failed to retrieve prototype
...
[181] = {"getpmsg", {T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_LLINT}, &syscall64_generic_handler}, // Unimplemented syscall
[182] = {"putpmsg", {T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_LLINT}, &syscall64_generic_handler}, // Unimplemented syscall
[183] = {"afs_syscall", {T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_LLINT}, &syscall64_generic_handler}, // Unimplemented syscall
[184] = {"tuxcall", {T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_LLINT}, &syscall64_generic_handler}, // Unimplemented syscall
[185] = {"security", {T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_LLINT}, &syscall64_generic_handler}, // Unimplemented syscall
...
[214] = {"epoll_ctl_old", {T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_LLINT}, &syscall64_generic_handler}, // Failed to retrieve prototype
[215] = {"epoll_wait_old", {T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_LLINT}, &syscall64_generic_handler}, // Failed to retrieve prototype
...
[221] = {"fadvise", {T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_LLINT}, &syscall64_generic_handler}, // Failed to retrieve prototype
[222] = {"timer_create", {T_INT, T_ADDR, T_ADDR, T_NONE, T_NONE, T_NONE, T_INT}, &syscall64_generic_handler},
[223] = {"timer_settime", {T_UNKNOWN, T_INT, T_ADDR, T_ADDR, T_NONE, T_NONE, T_INT}, &syscall64_generic_handler},
[224] = {"timer_gettime", {T_UNKNOWN, T_ADDR, T_NONE, T_NONE, T_NONE, T_NONE, T_INT}, &syscall64_generic_handler},
[225] = {"timer_getoverrun", {T_UNKNOWN, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_INT}, &syscall64_generic_handler}, // Unknown type
[226] = {"timer_delete", {T_UNKNOWN, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_INT}, &syscall64_generic_handler}, // Unknown type
...
[232] = {"epoll_wait", {T_INT, T_ADDR, T_INT, T_INT, T_NONE, T_NONE, T_INT}, &syscall64_generic_handler},
[233] = {"epoll_ctl", {T_INT, T_INT, T_INT, T_ADDR, T_NONE, T_NONE, T_INT}, &syscall64_generic_handler},
...
[236] = {"vserver", {T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_LLINT}, &syscall64_generic_handler}, // Unimplemented syscall
...
[250] = {"keyctl", {T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_LLINT}, &syscall64_generic_handler}, // Failed to retrieve prototype
...
[262] = {"newfstatat", {T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_LLINT}, &syscall64_generic_handler}, // Failed to retrieve prototype
...
[270] = {"pselect6", {T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_LLINT}, &syscall64_generic_handler}, // Failed to retrieve prototype
...
[289] = {"signalfd4", {T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_LLINT}, &syscall64_generic_handler}, // Failed to retrieve prototype
[290] = {"eventfd2", {T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_LLINT}, &syscall64_generic_handler}, // Failed to retrieve prototype
...
[305] = {"clock_adjtime", {T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_LLINT}, &syscall64_generic_handler}, // Failed to retrieve prototype
...
[333] = {"io_pgetevents", {T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_LLINT}, &syscall64_generic_handler}, // Failed to retrieve prototype
[334] = {"rseq", {T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_NONE, T_LLINT}, &syscall64_generic_handler} // Failed to retrieve prototype
